...
-- Dumping data for table amru_hotel.bookings: ~0 rows (approximately)
...
-- Dumping data for table amru_hotel.hotels: ~0 rows (approximately)
...
-- Dumping data for table amru_hotel.pengunjungs: ~0 rows (approximately)
